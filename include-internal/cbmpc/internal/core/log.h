...
struct dylog_disable_scope_t {
  ...
  dylog_disable_scope_t(const dylog_disable_scope_t&) = delete;
  dylog_disable_scope_t& operator=(const dylog_disable_scope_t&) = delete;
  dylog_disable_scope_t(dylog_disable_scope_t&&) = delete;
  dylog_disable_scope_t& operator=(dylog_disable_scope_t&&) = delete;
