...
struct key_share_eddsa_hdmpc_2p_t {
   ...
   */
  static error_t derive_keys(job_2p_t& job, const key_share_eddsa_hdmpc_2p_t& key, const bip32_path_t& hardened_path,
   ...
   * @notes:
   * - The initial part of this function is exactly the same as the eddsa-2pc key refresh.
   ...
   */
  static error_t refresh(job_2p_t& job, key_share_eddsa_hdmpc_2p_t& current_keyset,
                         key_share_eddsa_hdmpc_2p_t& new_keyset);
};
